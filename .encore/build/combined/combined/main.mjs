// This file was bundled by Encore v1.49.1
//
// https://encore.dev
...
// students/analytics.ts
import { api } from "encore.dev/api";

// students/db.ts
import { SQLDatabase } from "encore.dev/storage/sqldb";
var studentDB = new SQLDatabase("students", {
  migrations: "./migrations"
});

// students/analytics.ts
var getAnalytics = api(
  ...
  async (params) => {
    ...
    `;
    const basicStats = await studentDB.rawQueryRow(basicStatsQuery, ...queryParams);
    ...
    `;
    const distributionResults = await studentDB.rawQueryAll(
      distributionQuery,
      ...queryParams
    );
    ...
    const batchComparisonQuery = `
      ...
      ORDER BY batch
    `;
    const batchComparison = await studentDB.rawQueryAll(batchComparisonQuery);
    const topPerformersQuery = `
      ...
      LIMIT 10
    `;
    const topPerformers = await studentDB.rawQueryAll(topPerformersQuery, ...queryParams);
    return {
...
// students/get.ts
import { api as api2, APIError } from "encore.dev/api";
var getStudent = api2(
  { expose: true, method: "GET", path: "/students/:usn" },
  async (params) => {
    const student = await studentDB.queryRow`
...
var listStudents = api3(
  ...
  async (params) => {
    ...
    if (params.placement_eligible !== void 0) {
    ...
    const countResult = await studentDB.rawQueryRow(countQuery, ...queryParams);
    ...
    const students = await studentDB.rawQueryAll(studentsQuery, ...queryParams);
...
var seedSeventhSemData = api4(
  ...
  async () => {
    const students = [
      ...
      { name: "Charan kashayp M", usn: "4PM22CG011", tenth: 84.64, puc: 69.9, sem1: 60, sem2: 57.6, sem3: 61.2, sem4: 72.2, sem5: 68.2, sem6: 74.5, aggregate: 72.3, backlogs: 2 },
      ...
      { name: "Deekshitha R", usn: "4PM22CG014", tenth: 75.84, puc: 68.66, sem1: 57.71, sem2: 67.5, sem3: 74.88, sem4: 66.77, sem5: 74.11, sem6: 76.44, aggregate: 70, backlogs: 0 },
      ...
      { name: "Kruthika B I", usn: "4PM22CG022", tenth: 93, puc: 91, sem1: 78, sem2: 87, sem3: 84, sem4: 85, sem5: 88, sem6: 91, aggregate: 85.3, backlogs: 0 },
      ...
      { name: "Meghana KM", usn: "4PM22CG024", tenth: 78, puc: 67, sem1: 61.49, sem2: 63.2, sem3: 67.7, sem4: 70, sem5: 69.3, sem6: 69.5, aggregate: 71.56, backlogs: 0 },
      ...
      { name: "NISHANTH K R", usn: "4PM22CG028", tenth: 79, puc: 76, sem1: 61.5, sem2: 73, sem3: 77.6, sem4: 75.3, sem5: 83.6, sem6: 78.9, aggregate: 75.1, backlogs: 0 },
      ...
      { name: "Poornashree SV", usn: "4PM22CG032", tenth: 93, puc: 75.39, sem1: 69.25, sem2: 74.12, sem3: 84.23, sem4: 83.12, sem5: 89.34, sem6: 87.12, aggregate: 83.2, backlogs: 0 },
      { name: "PRATHAMESHA C SHETTY", usn: "4PM22CG033", tenth: 87, puc: 81, sem1: 79, sem2: 77.5, sem3: 74.8, sem4: 76, sem5: 75, sem6: 76, aggregate: 76, backlogs: 0 },
      { name: "Prerana Ashok Raikar", usn: "4PM22CG034", tenth: 79.04, puc: 68.33, sem1: 71.5, sem2: 74, sem3: 76.3, sem4: 74, sem5: 77.09, sem6: 81.9, aggregate: 79.04, backlogs: 0 },
      { name: "Priya y m", usn: "4PM22CG035", tenth: 88.8, puc: 81, sem1: 79.5, sem2: 85.5, sem3: 81, sem4: 75.7, sem5: 79, sem6: 78.4, aggregate: 75.9, backlogs: 0 },
      { name: "Rohan K Rajoli", usn: "4PM22CG036", tenth: 63, puc: 55.5, sem1: 62.5, sem2: 67.5, sem3: 65.2, sem4: 70, sem5: 75, sem6: 67.2, aggregate: 67.9, backlogs: 0 },
      { name: "Sachin k", usn: "4PM22CG037", tenth: 67, puc: 56, sem1: 60, sem2: 60, sem3: 60, sem4: 60, sem5: 60, sem6: 60, aggregate: 60, backlogs: 13 },
      { name: "Sakshi S Y", usn: "4PM22CG038", tenth: 85, puc: 76, sem1: 56, sem2: 70, sem3: 74, sem4: 68.5, sem5: 79, sem6: 75.1, aggregate: 77, backlogs: 1 },
      ...
      { name: "Shivshankar Awate", usn: "4PM22CG044", tenth: 83.52, puc: 84.66, sem1: 63.5, sem2: 67.8, sem3: 70.1, sem4: 67.9, sem5: 69.7, sem6: 72.5, aggregate: 68.6, backlogs: 0 },
      { name: "Shreya Janardhan Madival", usn: "4PM22CG045", tenth: 89.28, puc: 63.33, sem1: 76, sem2: 79.88, sem3: 87.22, sem4: 84.6, sem5: 85.7, sem6: 88.4, aggregate: 83.6, backlogs: 0 },
      ...
      { name: "Srushti N Y", usn: "4PM22CG049", tenth: 86, puc: 59.6, sem1: 61.5, sem2: 68.9, sem3: 83.4, sem4: 77.8, sem5: 84.1, sem6: 86, aggregate: 78, backlogs: 0 },
      ...
      { name: "Varsha S", usn: "4PM22CG061", tenth: 75.4, puc: 58, sem1: 62.25, sem2: 73.12, sem3: 81, sem4: 76.5, sem5: 78.3, sem6: 79.4, aggregate: 72.01, backlogs: 0 }
    ];
...
var seedFifthSemData = api4(
  ...
  async () => {
    const students = [
      ...
      { name: "Rakshitha A", usn: "4PM23CG036", tenth: 78, puc: 65, sem1: 81.5, sem2: 85, sem3: 81, sem4: 75, backlogs: 0 },
      { name: "Prathibha j mirajkar", usn: "4PM23CG033", tenth: 90, puc: 73, sem1: 64, sem2: 70, sem3: 76.7, sem4: 76.4, backlogs: 1 },
      { name: "Sahana A S", usn: "4PM23CG040", tenth: 50, puc: 65.5, sem1: 54.1, sem2: 56, sem3: 67.1, sem4: 58.4, backlogs: 6 },
      { name: "Ankitha L", usn: "4PM23CG005", tenth: 89.44, puc: 88, sem1: 78.75, sem2: 81.37, sem3: 80.88, sem4: 79.44, backlogs: 0 },
      { name: "Shambhavi M Y", usn: "4PM23CG045", tenth: 86.08, puc: 79.67, sem1: 88, sem2: 91.5, sem3: 90, sem4: 89.5, backlogs: 0 },
      { name: "Vijeta Vijaykumar Naik", usn: "4PM23CGO57", tenth: 97.6, puc: 90, sem1: 90, sem2: 95, sem3: 93.3, sem4: 88.4, backlogs: 0 },
      { name: "Rachana M", usn: "4pm23cg034", tenth: 69, puc: 78.5, sem1: 65, sem2: 70, sem3: 82, sem4: 78, backlogs: 0 },
      ...
      { name: "Yashaswini R", usn: "4PM23CG060", tenth: 89.12, puc: 81.83, sem1: 79.5, sem2: 83.5, sem3: 82.4, sem4: 81.1, backlogs: 0 },
      { name: "T P.Rohit", usn: "4PM23CG055", tenth: 61, puc: 80, sem1: 61.75, sem2: 64.12, sem3: 66.4, sem4: 58.7, backlogs: 0 },
      { name: "Rajath Ravikumar", usn: "4PM23CG035", tenth: 85.5, puc: 85, sem1: 85.5, sem2: 86.3, sem3: 83.3, sem4: 80.1, backlogs: 1 },
      { name: "Karthik AP", usn: "4PM23CG017", tenth: 89.5, puc: 88.94, sem1: 73.5, sem2: 75.5, sem3: 75.55, sem4: 75, backlogs: 0 },
      ...
      { name: "Deekshitha M R", usn: "4pm23cg012", tenth: 78, puc: 80, sem1: 78.5, sem2: 82, sem3: 84.3, sem4: 79.5, backlogs: 0 },
      ...
      { name: "Shivani NS", usn: "4pm23cg047", tenth: 84, puc: 81, sem1: 73.62, sem2: 80.8, sem3: 86, sem4: 81.8, backlogs: 0 },
...
// students/encore.service.ts
import { Service } from "encore.dev/service";
var encore_service_default = new Service("students");
